import { ImageObject, SlideObject, SlideObjectType, TextObject, PrimitiveType, TriangleObject, SquareObject, CircleObject, Char} from "../models/types";
import {v4 as uuidv4} from 'uuid';


class SlideObjectGenerator {
    public Generate(type: string, subtype?: string): SlideObject|undefined {
        switch(type) { 
