...
const slide1: Slide = [textObject, imageObject, circleObject, squareObject, triangleObject]
const slide2: Slide = [textObject, imageObject, circleObject, squareObject, triangleObject]
